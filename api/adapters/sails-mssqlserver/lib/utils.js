...
/**
 * Builds a Count statement used for paging.
 */

utils.buildCountStatement = function (table, options) {

  var whatToCount = "*"
  if (options.groupBy) {
    whatToCount = "DISTINCT "
    // Normalize to array
  ...
  var query = 'SELECT COUNT('+ whatToCount +') as __totalrows__ ';
